...
Создай законченную интерактивную HTML-презентацию на русском языке: «Глава 8. Транспортный уровень».
...
СТИЛЬ
Прочитай приложенный DESIGN.md и следуй ему: он задаёт палитру, типографику, композицию, адаптивность, навигацию и анимации.
